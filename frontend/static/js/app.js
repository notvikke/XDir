...
const SETTINGS_JOB_DEFINITIONS = {
    ...
    'export-library': {
        ...
        initialMessage: 'Exporting your source links, local path mappings, playtime, and saved library metadata...',
        genericFailureMessage: 'Failed to export the portable library metadata package',
        idleHtml: `<i data-lucide="download"></i> <span>Export Library Metadata</span>`,
        loadingHtml: `<i data-lucide="loader" class="spin"></i> <span>Exporting Library Metadata...</span>`,
    },
    'import-library': {
        buttonId: 'btn-settings-import-library',
        startUrl: `${API_BASE}/api/library/import`,
        initialMessage: 'Importing library metadata, source links, and saved local path mappings into the current library...',
        genericFailureMessage: 'Failed to import the portable library metadata package',
        idleHtml: `<i data-lucide="upload"></i> <span>Import Library Metadata</span>`,
        loadingHtml: `<i data-lucide="loader" class="spin"></i> <span>Importing Library Metadata...</span>`,
    },
    'update-check': {
